...
function seeandcomplete2() {
    
    var appcenter = document.getElementById('noti.');
    if (appcenter.style.display == 'none') {
        
        appcenter.style.display = 'block';
        document.getElementById("noti.").style.animation = "openopacity 2s 1";
    } else {
        document.getElementById("noti.").style.animation = "closeopacity 2s 1";
        setTimeout(function(){ appcenter.style.display = 'none'; }, 1900);
    }
}
